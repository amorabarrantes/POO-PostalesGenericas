...
public class proyectosCreados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Ver Propiedades de imagen");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        mi.imagenOriginal = mi.buscarProyecto(jListProyectos.getSelectedValue()).getImagenOriginal().getRuta();
        mi.imagenGenerada = mi.buscarProyecto(jListProyectos.getSelectedValue()).getImagenGenerada().getRuta();
        Propiedades frame;
        try {
            frame = new Propiedades();
            frame.setVisible(true);
            frame.setLocationRelativeTo(null);
